    ...
    <div className="min-h-[calc(100vh-76px)] bg-neobg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white/[0.02] border border-white/5 max-w-md w-full p-8 rounded-2xl shadow-neo backdrop-blur-md relative z-10">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <h2 className="font-sans text-xl font-bold text-white tracking-wide">Operator Registration</h2>
          <p className="text-zinc-500 text-xs font-mono uppercase mt-1.5 tracking-wider">Spin up new operator profile</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-neogreen to-necyan text-black font-extrabold uppercase shadow-sm hover:opacity-90 active:scale-98 transition-all duration-150 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
